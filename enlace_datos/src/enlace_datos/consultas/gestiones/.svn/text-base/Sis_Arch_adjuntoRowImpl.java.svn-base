...
// ---------------------------------------------------------------------
public class Sis_Arch_adjuntoRowImpl extends ViewRowImpl {
     ...
     */
    public Sis_Arch_adjuntoRowImpl() {
    }
    ...
    public String getnomArchEncript() {
        String vValor, vContentType, vNomArchivo;
        encription encript;
            ...
            if (vNomArchivo!=null && vNomArchivo.equalsIgnoreCase("")==false) {
                if ( vNomArchivo.indexOf(".") >= 0) {
                    ...
                    if (vContentType.equalsIgnoreCase("jpeg")){
                        vContentType = "image/jpeg";
                    } else if (vContentType.equalsIgnoreCase("x-png")){
                        vContentType = "image/x-png";
             ...
             //System.out.println("El nombre del archivo es: " + vNomArchivo + ", y su Tipo de Contenido es: " + vContentType);
             if (this.getTamdata().equals(new Number(0))){
                if (this.getIdContrato()!=null) vNomArchivo=vNomArchivo+"|C|"+vContentType;
                else if (this.getRegistroEmpleado()!=null) vNomArchivo=vNomArchivo+"|E|"+vContentType;
                else if (this.getIdAnexo()!=null) vNomArchivo=vNomArchivo+"|A|"+vContentType;
                else if (this.getIdSolicitud()!=null) vNomArchivo=vNomArchivo+"|S|"+vContentType;
                else if (this.getIdVariacionNomina()!=null) vNomArchivo=vNomArchivo+"|V|"+vContentType;
            } else {
                vNomArchivo=this.getIdArchivoAdjunto()+"|G|"+vContentType;  
            }
            vValor=encript.encriptarDES(vNomArchivo,null);
