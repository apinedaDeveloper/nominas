...
// ---------------------------------------------------------------------
public class arch_adjunto_contratoRowImpl extends ViewRowImpl {
     ...
     */
    public arch_adjunto_contratoRowImpl() {
    }
    ...
    public String getnomArchEncript() {
        ...
        if (this.getTamdata().compareTo(1)>=0)
        {
            ...
            vValor=encript.encriptarDES(this.getNomArchivo()+"|C|"+vContentType,null);
