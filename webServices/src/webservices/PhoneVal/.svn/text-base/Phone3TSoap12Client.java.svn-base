...
public class Phone3TSoap12Client {
    private webservices.PhoneVal.Phone3TSoap _port;
    
    public Phone3TSoap12Client() throws Exception {
        ServiceFactory factory = ServiceFactory.newInstance();
        _port = ((webservices.PhoneVal.Phone3T)factory.loadService(webservices.PhoneVal.Phone3T.class)).getPhone3TSoap12();
    }
    ...
    public static void main(String[] args) {
        try {
            webservices.PhoneVal.Phone3TSoap12Client myPort = new webservices.PhoneVal.Phone3TSoap12Client();
